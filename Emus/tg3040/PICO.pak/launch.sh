...
export picodir=/mnt/SDCARD/Emus/tg3040/PICO.pak/PICO8_Wrapper
cd $picodir
...
if ! [ -f /mnt/SDCARD/Emus/tg3040/PICO.pak/PICO8_Wrapper/bin/pico8_64 ] || ! [ -f /mnt/SDCARD/Emus/tg3040/PICO.pak/PICO8_Wrapper/bin/pico8.dat ]; then
...
main() {
	...
	mount --bind /mnt/SDCARD/Roms/PICO8 /mnt/SDCARD/Emus/tg3040/PICO.pak/PICO8_Wrapper/.lexaloffle/pico-8/carts
